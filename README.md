...
https://github.com/DRCL-USC/RL_augmented_MPC

## Training Tools

https://github.com/fan-ziqi/rl_docker

## Deployment

https://github.com/fan-ziqi/rl_sar

https://github.com/KK-Zhou/State_RL

https://github.com/dstx123/unitree_rl

## Competitions

https://github.com/teamgrit-lab/ICRA2024_Quadruped_Robot_Challenges

## Paper

https://github.com/yingchengyang/Reinforcement-Learning-Papers

[Adversarial Motion Priors Make Good Substitutes for Complex Reward Functions](https://ieeexplore.ieee.org/abstract/document/9981973/)
...
[DeepMimic Example-Guided Deep Reinforcement Learning of Physics-Based Character Skills](https://dl.acm.org/doi/abs/10.1145/3197517.3201311)

[DreamWaQ Learning Robust Quadrupedal Locomotion With Implicit Terrain Imagination via Deep Reinforcement Learning](https://ieeexplore.ieee.org/abstract/document/10161144/)
...
[Flexible Muscle-Based Locomotion for Bipedal Creatures](https://dl.acm.org/doi/abs/10.1145/2508363.2508399)

[From Knowing to Doing Learning Diverse Motor Skills through Instruction Learning](https://arxiv.org/abs/2309.09167)

[GenLoco Generalized Locomotion Controllers for Quadrupedal Robots](https://proceedings.mlr.press/v205/feng23a.html)

[Hybrid Internal Model Learning Agile Legged Locomotion with Simulated Robot Response](https://arxiv.org/abs/2312.11460)

[Learning Agile Bipedal Motions on a Quadrupedal Robot](https://arxiv.org/abs/2311.05818)

[Learning Multiple Gaits within Latent Space for Quadruped Robots](https://arxiv.org/abs/2308.03014)

[Learning Robust and Agile Legged Locomotion Using Adversarial Motion Priors](https://ieeexplore.ieee.org/abstract/document/10167753/)

[Learning Robust, Agile, Natural Legged Locomotion Skills in the Wild](https://openreview.net/forum?id=b5hiuuX1sm)
...
[Walk these Ways Tuning Robot Control for Generalization with Multiplicity of Behavior](https://proceedings.mlr.press/v205/margolis23a.html)
